...
import { InquiryButton, InquiryProvider } from "components/studio-site/inquiry";

const CONTACT = "mailto:evan@shapereality.com?subject=Project%20brief";

// Shape Reality v2 shell: adaptive paper/ink (same scheme as /uncharted),
// constant 20px frame, mono bracket labels, film accents on interaction.
// Nav is the buyer's journey in three stops: what it is (Solutions) → what
// you get (Services) → do it (Start a project). Everything else lives in the
// hubs or the footer (site architecture v2, 2026-07-16).
        ...
        <header className="sticky top-0 z-50 bg-[var(--paper)]/90 backdrop-blur">
          <div className="flex items-center justify-between px-5 py-5">
            ...
            <nav className="flex items-center gap-5 font-mono text-[11px] uppercase tracking-[0.16em]">
              ...
              <InquiryButton className="rounded-full border border-[var(--hairline)] px-4 py-2 text-[var(--ink)] transition-colors hover:border-[var(--ink)]">
                Start a project
              </InquiryButton>
            </nav>
          </div>
